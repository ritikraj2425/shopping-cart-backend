        ...
        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
          ...
          <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
            ...
            <div className="flex justify-between items-center">
              ...
              <div className='flex'>
                <button className="flex ml-auto text-white bg-black border-0 py-2 px-6 focus:outline-none hover:bg-white hover:text-black rounded" onClick={() => handleCart(product)}>Add to Cart</button> 
              </div>
