...
const LoginPage = () => {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            const response = await fetch('https://shopping-cart-backend-tan.vercel.app/login', {
                method: 'POST',
                body: JSON.stringify({
                    email,
                    password
    ...
    return (
        <div className="min-h-screen bg-gray-100 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
            ...
            <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
                <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10" onSubmit={handleLogin}>
